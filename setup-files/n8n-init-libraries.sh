...
# Все библиотеки теперь устанавливаются на этапе сборки Docker-образа.
echo -e "${GREEN}✅ Все необходимые npm-библиотеки уже установлены в кастомном Docker-образе n8n.${NC}"
FAILED=0
