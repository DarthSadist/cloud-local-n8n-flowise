...
- **n8n** - платформа автоматизации рабочих процессов с низкокодовым интерфейсом
  ...
  - Поддерживает использование сторонних JavaScript библиотек и хелперов
  - Расширенная поддержка библиотек для обработки изображений, документов и архивов
...
- **Расширенная поддержка библиотек**:
  - Обработка изображений: sharp, tesseract.js, gm, image-size, heic-convert
  - Работа с документами: pdf-lib, xlsx, exceljs, mammoth, html-pdf
  - Работа с архивами: jszip, archiver, unzipper
  - Встроенные хелперы для упрощения работы с библиотеками
